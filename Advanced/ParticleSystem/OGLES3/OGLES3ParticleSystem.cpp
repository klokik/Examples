...
******************************************************************************/
bool OGLES3ParticleSystem::LoadVbos(CPVRTString* const pErrorStr)
{
...
******************************************************************************/
bool OGLES3ParticleSystem::LoadShaders(CPVRTString* const pErrorStr)
{
	/*
	 *  Simple Shader
	 */
...
******************************************************************************/
void OGLES3ParticleSystem::RenderSphere(PVRTVec3 position, float radius)
{
...
******************************************************************************/
void OGLES3ParticleSystem::RenderParticles()
{	
	glEnable(GL_BLEND);
...
******************************************************************************/
float OGLES3ParticleSystem::UpdateFramerateCounter()
{
