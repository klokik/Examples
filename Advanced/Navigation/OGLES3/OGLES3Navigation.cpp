...
struct ShaderDescription
{
	...
	const PVRTuint32 ui32NumAttributes;
...
/*!***********************************************************************
 *	@Class  OGLES3Navigation
 *	@Brief  Navigation demo main class.
 ************************************************************************/
class OGLES3Navigation : public PVRShell
{
...
******************************************************************************/
bool OGLES3Navigation::LoadTextures(CPVRTString* const pErrorStr)
{
...
******************************************************************************/
bool OGLES3Navigation::LoadShader(CPVRTString* pErrorStr, const ShaderDescription &descr, Shader &shader)
{
...
******************************************************************************/
bool OGLES3Navigation::LoadShaders(CPVRTString* pErrorStr)
{
...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool OGLES3Navigation::InitApplication()
{
	m_bPause = false;
	m_fFOV = 45.0f;
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.
******************************************************************************/
bool OGLES3Navigation::QuitApplication()
{
	for (unsigned int i=0; i < m_uiLayerCount; i++)
	{
...
******************************************************************************/
bool OGLES3Navigation::InitView()
{
...
******************************************************************************/
bool OGLES3Navigation::ReleaseShader(Shader &shader)
{
...
******************************************************************************/
bool OGLES3Navigation::ReleaseView()
{
	// Delete textures
...
******************************************************************************/
bool OGLES3Navigation::RenderScene()
{
...
******************************************************************************/
void OGLES3Navigation::UpdateTimer()
{
...
******************************************************************************/
void OGLES3Navigation::UpdateObjectset()
{
...
******************************************************************************/
void OGLES3Navigation::HandleInput()
{
	// Handle user input
...
/*!****************************************************************************
 ...
 @Description	Renders
******************************************************************************/
void OGLES3Navigation::Render(const RenderLayer *pRenderLayer)
{
...
******************************************************************************/
void OGLES3Navigation::RenderTriangles(const RenderLayer *pRenderLayer, const Shader &shader)
{
...
******************************************************************************/
void OGLES3Navigation::RenderPivotQuads(const PivotQuadShader &shader, const RenderLayer *pRenderLayer, GLuint textureId)
{
	if (pRenderLayer->pworkingset->Size() == 0)
		return;
...
/*!****************************************************************************
 ...
 @Description	Draws a rectangle the size of the maps bounding boxes.
******************************************************************************/
void OGLES3Navigation::RenderGround()
{
...
/*!****************************************************************************
 ...
 @Description	Creates a VBO of a bucket of coordinates and adds it to the
				...
				already cached.
******************************************************************************/
void OGLES3Navigation::CacheBucketIndexSet(RenderLayer *pRenderLayer, const unsigned int bucketindex)
{
...
/*!****************************************************************************
 ...
 @Description	Decreases reference count of VBO and removes VBO if not
                required any longer.
******************************************************************************/
void OGLES3Navigation::RemoveBucketIndexSet(RenderLayer *pRenderLayer, const unsigned int bucketindex)
{
	const unsigned int index = pRenderLayer->mapbucket.pIndexDataBuckets[bucketindex].bucketindex;
	RenderCache &rendercache = pRenderLayer->prendercache[index];
	if (rendercache.references == 0)
...
/*!****************************************************************************
 ...
 @Description	Checks whether the given VBO is already bound and binds it if
                necessary.
******************************************************************************/
void OGLES3Navigation::BindVBO(GLuint vbo)
{
...
******************************************************************************/
void OGLES3Navigation::BindTexture(GLenum unit, GLuint id)
{
...
******************************************************************************/
void OGLES3Navigation::CalculateCameraMatrices()
{
	// Animate the camera
...
******************************************************************************/
void OGLES3Navigation::CalculateClipPlanes(float &nearplane, float &farplane)
{
...
***********************************************************************************************/
void OGLES3Navigation::CalculateViewFrustumCorners(PVRTViewFrustum &corners) const
{
...
***********************************************************************************************/
void OGLES3Navigation::CalculateCameraBoundingCircle(const PVRTVec4 &plane, const float shift, PVRTBoundingCircle &circle)
{
...
***********************************************************************************************/
bool OGLES3Navigation::CircleIntersectsBoundingBox(const PVRTBoundingBox2D &bbox, const PVRTBoundingCircle &circle)
{
...
******************************************************************************/
float OGLES3Navigation::CalculateLinePlaneIntersection(const PVRTVec4 &plane, const PVRTVec3 &a, const PVRTVec3 &b) const
{
...
******************************************************************************/
void OGLES3Navigation::ReadData(const char **pSrc, void *pDst, PVRTuint32 size) const
{
...
******************************************************************************/
bool OGLES3Navigation::CheckMarker(const char **pData, unsigned int token) const
{
...
***********************************************************************************************/
bool OGLES3Navigation::LoadPVRTMapBucket(const char *pszFilename, PVRTMapBucket &layer) const
{
...
PVRShell* NewDemo()
{
	return new OGLES3Navigation();
}

/******************************************************************************
 End of file (OGLES3Navigation.cpp)
******************************************************************************/
