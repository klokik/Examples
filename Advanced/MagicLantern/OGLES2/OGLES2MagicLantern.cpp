...
******************************************************************************/
class OGLES2MagicLantern : public PVRShell, public PVRTPFXEffectDelegate
{
...
*****************************************************************************/
EPVRTError OGLES2MagicLantern::PVRTPFXOnLoadTexture(const CPVRTStringHash& TextureName, GLuint& uiHandle, unsigned int& uiFlags)
{
	/*
...
******************************************************************************/
void OGLES2MagicLantern::DrawMesh(int i32NodeIndex, CPVRTPFXEffect *pCurrentFX)
{
