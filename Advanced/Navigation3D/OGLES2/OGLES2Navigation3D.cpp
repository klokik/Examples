...
/*!****************************************************************************
 ...
 @Description	Loads the assets required for the demo and display progress
                messages.
******************************************************************************/
bool OGLES2Navigation3D::LoadAssets(bool &finished)
{
	finished = false;
...
******************************************************************************/
void OGLES2Navigation3D::RenderUI()
{
	if (m_abStates[STATE_UI])
	{
		...
		for (unsigned int i=0; i < NUM_STATES; i++)
		{
			...
			case STATE_OCCLUSION:
				{
					PVRTVec2 location = PVRTVec2(m_Buttons[i].minCoords.x - 0.5f, 0.5f - m_Buttons[i].minCoords.y) * 2.0f;
...
******************************************************************************/
void OGLES2Navigation3D::InitUI()
{
...
******************************************************************************/
void OGLES2Navigation3D::UpdateTimer()
{
...
/*!****************************************************************************
 ...
 @Description	Handles user input via mouse interactions.
******************************************************************************/
void OGLES2Navigation3D::HandleMouseDrag(PVRTVec2 dir)
{
	if (m_abStates[STATE_PAUSE])
	{
		if (m_bRotate)
...
/*!****************************************************************************
 ...
 @Description	Renders the visible city blocks based on the view frustum
                intersection tests.
******************************************************************************/
void OGLES2Navigation3D::Render3dModelsVisibilitySet()
{
	PVRTVec4 planes[4];
	ExtractViewFrustumPlanes(m_mViewProjectionMatrixNonRotated, planes[0], planes[1], planes[2], planes[3]);
...
/*!****************************************************************************
 ...
 @Description	TODO
******************************************************************************/
void OGLES2Navigation3D::CalculateLightMatrices()
{
...
******************************************************************************/
void OGLES2Navigation3D::ExtractViewFrustumPlanes(const PVRTMat4 &matrix, PVRTVec4 &left, PVRTVec4 &right, PVRTVec4 &front, PVRTVec4 &back) const
{
...
******************************************************************************/
int OGLES2Navigation3D::BoundingBoxIntersectsFrustum(const PVRTBoundingBox2D &bbox, const PVRTVec4 planes[4]) const
{
	int totalinside = 0;
...
******************************************************************************/
void OGLES2Navigation3D::CreateShadowVolumes(unsigned int tile)
{
...
******************************************************************************/
void OGLES2Navigation3D::ReleaseShadowVolumes()
{
	for (unsigned int i=0; i < m_uiNumPVRTCityBlocks; i++)
	{
...
******************************************************************************/
void OGLES2Navigation3D::UpdateShadowVolumes()
{
...
******************************************************************************/
void OGLES2Navigation3D::RenderShadowVolumes()
{
