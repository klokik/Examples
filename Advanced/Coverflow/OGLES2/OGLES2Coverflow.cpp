...
******************************************************************************/
class OGLES2Coverflow : public PVRShell
{
...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool OGLES2Coverflow::InitApplication()
{
	m_fLerp = 0.f;
	m_fLerpDir = 0;
	m_ulTimePrev = 0;
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.
******************************************************************************/
bool OGLES2Coverflow::QuitApplication()
{
	return true;
}
...
******************************************************************************/
bool OGLES2Coverflow::ReleaseView()
{
	m_Print3D.ReleaseTextures();
	return true;
}

bool OGLES2Coverflow::LoadTextures(CPVRTString* const pErrorStr)
{
...
void OGLES2Coverflow::CreateCover()
{
	int i, row, col;
	float width = 6.0f;
	float height = 6.0f;
...
******************************************************************************/
bool OGLES2Coverflow::RenderScene()
{
...
void OGLES2Coverflow::DrawLeftCovers()
{
...
void OGLES2Coverflow::DrawRightCovers()
{
...
PVRShell* NewDemo()
{
	return new OGLES2Coverflow();
}

/******************************************************************************
 End of file (OGLES2Coverflow.cpp)
******************************************************************************/
