/******************************************************************************
 ...
 @File         OGLES3PVRScopeExample.cpp
...
******************************************************************************/
class OGLES3PVRScopeExample : public PVRShell
{
...
******************************************************************************/
bool OGLES3PVRScopeExample::LoadTextures(CPVRTString* const pErrorStr)
{
...
******************************************************************************/
bool OGLES3PVRScopeExample::LoadShaders(CPVRTString* pErrorStr)
{
	/*
...
******************************************************************************/
void OGLES3PVRScopeExample::LoadVbos()
{
...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool OGLES3PVRScopeExample::InitApplication()
{
	m_puiVbo = 0;
	m_puiIndexVbo = 0;
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.x
******************************************************************************/
bool OGLES3PVRScopeExample::QuitApplication()
{
...
******************************************************************************/
bool OGLES3PVRScopeExample::InitView()
{
	...
	*/
	...
	if(m_pScopeGraph)
	{
		...
		{
			PVRShellOutputDebug("(%i) Name %s Group %i\n", i, m_pScopeGraph->GetCounterName(i), m_pScopeGraph->GetCounterGroup(i));
			m_pScopeGraph->ShowCounter(i, false);
		}

		// Set the active group to 0
		m_pScopeGraph->SetActiveGroup(0);
...
******************************************************************************/
bool OGLES3PVRScopeExample::ReleaseView()
{
	// Delete textures
...
******************************************************************************/
bool OGLES3PVRScopeExample::RenderScene()
{
...
******************************************************************************/
void OGLES3PVRScopeExample::DrawMesh(int i32NodeIndex)
{
...
PVRShell* NewDemo()
{
	return new OGLES3PVRScopeExample();
}

/******************************************************************************
 End of file (OGLES3PVRScopeExample.cpp)
******************************************************************************/
