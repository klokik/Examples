...
******************************************************************************/
void OGLES3Water::DrawScene(const ModelShader& shaderProgram)
{
	// Draw meshes
...
******************************************************************************/
void OGLES3Water::DrawRefractionScene(const ModelShader& shaderProgram)
{
	// Draw meshes
	DrawMeshScene(shaderProgram);
}
...
******************************************************************************/
void OGLES3Water::DrawMesh(GLuint uiModelNo, int i32NodeIndex, const ModelShader& shaderProgram)
{
...
******************************************************************************/
void OGLES3Water::DrawMeshScene(const ModelShader &shaderProgram)
{
