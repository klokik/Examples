...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool OGLES3ExampleUI::InitApplication()
{
...
bool OGLES3ExampleUI::InitView()
{
	...
	m_uiBaseW = MakePowerOfTwo(PVRShellGet(prefWidth));
	m_uiBaseH = MakePowerOfTwo(PVRShellGet(prefHeight));
...
/*!****************************************************************************
 ...
 @Description	Loads an array of individual sprites that will be used to create
				a texture atlas.
******************************************************************************/
bool OGLES3ExampleUI::LoadSprites(CPVRTString* const pErrorStr)
{
	GLuint i = 0;
...
******************************************************************************/
bool OGLES3ExampleUI::LoadShaders(CPVRTString* const pErrorStr)
{
	/*
...
******************************************************************************/
bool OGLES3ExampleUI::GenerateAtlas()
{
	...
	CPVRTArray<SpriteDesc*> aSortedSprites(eSPRITE_SIZE);
	for(GLuint i = 0; i < eSPRITE_SIZE; ++i)
		aSortedSprites[i] = &m_aSprites[i];
...
******************************************************************************/
bool OGLES3ExampleUI::ReleaseView()
{
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.
******************************************************************************/
bool OGLES3ExampleUI::QuitApplication()
{
...
/*!****************************************************************************
 ...
 @Description	Enables the various attribute array and binds the vertex pointers
				...
				and upload data.
******************************************************************************/
void OGLES3ExampleUI::LockBuffers()
{
...
******************************************************************************/
void OGLES3ExampleUI::ReleaseBuffers()
{
	// Unbind
	glBindBuffer(GL_ARRAY_BUFFER, 0);
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0);
...
******************************************************************************/
void OGLES3ExampleUI::RenderUIGroup(eSpriteGroup Group, const PVRTMat4& mProj)
{
	// Upload MVP matrix.
...
******************************************************************************/
void OGLES3ExampleUI::RenderPage(eDisplayPage Page, const PVRTMat4& mTransform)
{
	PVRTMat4 mMVP;
...
******************************************************************************/
int OGLES3ExampleUI::CountRequiredVertices()
{
	int i32Verts = 0;
	GLushort idx = 0;
	for(GLuint i = 0; i < c_uiNumSprites; ++i)
...
******************************************************************************/
int OGLES3ExampleUI::CountRequiredIndices()
{
	int i32Indices = 0;
	GLushort idx = 0;
	for(GLuint i = 0; i < c_uiNumSprites; ++i)
...
******************************************************************************/
void OGLES3ExampleUI::ApplyClipping(eClipShape Clip, const PVRTMat4& mMVP)
{
	// Begin stencil test
...
******************************************************************************/
void OGLES3ExampleUI::StopClipping()
{
...
/******************************************************************************
 End of file (OGLES3ExampleUI.cpp)
******************************************************************************/
