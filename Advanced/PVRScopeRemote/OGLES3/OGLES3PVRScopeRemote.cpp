...
******************************************************************************/
class OGLES3PVRScopeRemote : public PVRShell
{
...
******************************************************************************/
bool OGLES3PVRScopeRemote::LoadTextures(CPVRTString* const pErrorStr)
{
...
******************************************************************************/
void OGLES3PVRScopeRemote::LoadVbos()
{
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.
******************************************************************************/
bool OGLES3PVRScopeRemote::QuitApplication()
{
...
******************************************************************************/
bool OGLES3PVRScopeRemote::InitView()
{
...
******************************************************************************/
bool OGLES3PVRScopeRemote::ReleaseView()
{
	// Delete textures
...
bool OGLES3PVRScopeRemote::RenderScene()
{
	if(m_psSPSCommsData)
	{
		...
		if(!(m_i32FrameCounter % 100))
		{
			...
			PVRShellOutputDebug("Sending \"%s\"\n", buf);
			if(!pplSendMark(*m_psSPSCommsData, buf, nLen))
				PVRShellOutputDebug("pplSendMark failed (\"%s\")\n", buf);
		}
	...
	*/
	...
	if(!pplCountersUpdate(*m_psSPSCommsData, m_anCounterReadings))
	{
		PVRShellOutputDebug("PVRScopeRemote: pplCountersUpdate() failed\n");
	}
...
PVRShell* NewDemo()
{
	return new OGLES3PVRScopeRemote();
}

/******************************************************************************
 End of file (OGLES3PVRScopeRemote.cpp)
******************************************************************************/
