...
******************************************************************************/
class OGLES3LevelOfDetail : public PVRShell
{
...
******************************************************************************/
bool OGLES3LevelOfDetail::LoadTextures(CPVRTString* const pErrorStr)
{
...
******************************************************************************/
bool OGLES3LevelOfDetail::LoadShaders(CPVRTString* pErrorStr)
{
	/*
...
******************************************************************************/
void OGLES3LevelOfDetail::LoadVbos()
{
...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool OGLES3LevelOfDetail::InitApplication()
{
	m_puiVbo = 0;
	m_puiIndexVbo = 0;
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.x
******************************************************************************/
bool OGLES3LevelOfDetail::QuitApplication()
{
...
******************************************************************************/
bool OGLES3LevelOfDetail::InitView()
{
...
******************************************************************************/
bool OGLES3LevelOfDetail::ReleaseView()
{
	// Delete textures
...
******************************************************************************/
bool OGLES3LevelOfDetail::RenderScene()
{
	...
	*/
	...
	m_Print3D.DisplayDefaultTitle("Level of detail", (m_bHighDetail) ? "Detail: high" : "Detail: low", ePVRTPrint3DSDKLogo);
	m_Print3D.Flush();
	return true;
}

void OGLES3LevelOfDetail::ProjectVertex(PVRTVec4& Vector, PVRTMat4& Matrix, float& fX, float& fY)
{
	PVRTVec4 vProj;
	vProj = Matrix * Vector;
...
******************************************************************************/
void OGLES3LevelOfDetail::DrawMesh(int i32NodeIndex)
{
...
PVRShell* NewDemo()
{
	return new OGLES3LevelOfDetail();
}

/******************************************************************************
 End of file (OGLES3LevelOfDetail.cpp)
******************************************************************************/
