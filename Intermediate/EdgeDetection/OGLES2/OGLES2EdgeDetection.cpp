...
******************************************************************************/
class OGLES2EdgeDetection : public PVRShell
{
...
public:
	OGLES2EdgeDetection() :	m_pvColorData(0), m_puiVbo(0), m_puiIndexVbo(0), m_uiShaderID(1),
							m_ulPreviousTimeAngle(0), m_ulPreviousTimeFPS(0), m_ulCurrentTime(0),
							m_fAngleY(0), m_fFPS(0), m_fLineWidth(1.0f),m_iFrameCount(0),
							m_i32TexWidth(0),m_i32TexHeight(0),	m_bDiscard(false){}
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.
******************************************************************************/
bool OGLES2EdgeDetection::QuitApplication()
{
...
******************************************************************************/
void OGLES2EdgeDetection::SetupView(bool bRotate)
{
...
******************************************************************************/
bool OGLES2EdgeDetection::CreateFBO(CPVRTString* pErrorStr)
{
	// Enable depth test
...
******************************************************************************/
bool OGLES2EdgeDetection::LoadTextures(CPVRTString* pErrorStr)
{
...
******************************************************************************/
bool OGLES2EdgeDetection::LoadShaders(CPVRTString* pErrorStr)
{
...
******************************************************************************/
bool OGLES2EdgeDetection::LoadVbos(CPVRTString* pErrorStr)
{
...
******************************************************************************/
bool OGLES2EdgeDetection::ReleaseView()
{
...
/*!****************************************************************************
 ...
 @Description	Draws a SPODMesh after the model view matrix has been set.
				...
				this case.
******************************************************************************/
void OGLES2EdgeDetection::DrawMesh(unsigned int ui32MeshID)
{
...
******************************************************************************/
void OGLES2EdgeDetection::DrawQuad()
{
...
PVRShell* NewDemo()
{
	return new OGLES2EdgeDetection();
}

/******************************************************************************
 End of file (OGLES2EdgeDetection.cpp)
******************************************************************************/
