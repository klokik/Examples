/******************************************************************************
 ...
 @File         OGLES2AnisotropicLighting.cpp
...
******************************************************************************/
class OGLES2AnisotropicLighting : public PVRShell
{
...
******************************************************************************/
bool OGLES2AnisotropicLighting::LoadTextures(CPVRTString* const pErrorStr)
{
...
******************************************************************************/
void OGLES2AnisotropicLighting::LoadVbos()
{
...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool OGLES2AnisotropicLighting::InitApplication()
{
	m_puiVbo = 0;
	m_puiIndexVbo = 0;
...
******************************************************************************/
void OGLES2AnisotropicLighting::DrawMesh(int i32NodeIndex)
{
...
PVRShell* NewDemo()
{
	return new OGLES2AnisotropicLighting();
}

/******************************************************************************
 End of file (OGLES2AnisotropicLighting.cpp)
******************************************************************************/
