...
******************************************************************************/
class OGLES3Refraction : public PVRShell
{
...
******************************************************************************/
bool OGLES3Refraction::LoadTextures(CPVRTString* const pErrorStr)
{
...
******************************************************************************/
bool OGLES3Refraction::LoadShaders(CPVRTString* pErrorStr)
{
	/*
...
******************************************************************************/
void OGLES3Refraction::LoadVbos()
{
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.x
******************************************************************************/
bool OGLES3Refraction::QuitApplication()
{
...
******************************************************************************/
void OGLES3Refraction::DrawMesh(int i32NodeIndex)
{
...
PVRShell* NewDemo()
{
	return new OGLES3Refraction();
}

/******************************************************************************
 End of file (OGLES3Refraction.cpp)
******************************************************************************/
