/******************************************************************************
 ...
 @File         OGLES3MultipleRenderTargets.cpp
...
******************************************************************************/
class OGLES3MultipleRenderTargets : public PVRShell, public PVRTPFXEffectDelegate
{
...
*****************************************************************************/
EPVRTError OGLES3MultipleRenderTargets::PVRTPFXOnLoadTexture(const CPVRTStringHash& TextureName, GLuint& uiHandle, unsigned int& uiFlags)
{
	uiFlags = 0;
...
******************************************************************************/
void OGLES3MultipleRenderTargets::LoadVbos()
{
...
******************************************************************************/
bool OGLES3MultipleRenderTargets::CreateFBO(CPVRTString *pszErrorMsg)
{
	...
	const GLenum formats[] = { GL_RGB, GL_RED, GL_RED, GL_RGB };
	const GLenum internalformat[] = { GL_RGB8, GL_R8, GL_R8, GL_RGB8 };
	...
	glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH_COMPONENT24, c_uiRenderTargetSize, c_uiRenderTargetSize);
	...
	glDrawBuffers(c_uiNumRenderTargets, drawbuffers);
...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool OGLES3MultipleRenderTargets::InitApplication()
{
	m_puiVbo = 0;
	m_puiIndexVbo = 0;
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.x
******************************************************************************/
bool OGLES3MultipleRenderTargets::QuitApplication()
{
...
******************************************************************************/
bool OGLES3MultipleRenderTargets::InitView()
{	
...
******************************************************************************/
bool OGLES3MultipleRenderTargets::ReleaseView()
{
	// Release textures
	{
...
******************************************************************************/
bool OGLES3MultipleRenderTargets::RenderScene()
{
	Update();
...
*****************************************************************************/
void OGLES3MultipleRenderTargets::DrawAxisAlignedQuad(PVRTVec2 afLowerLeft, PVRTVec2 afUpperRight, CPVRTPFXEffect *pEffect)
{	
...
******************************************************************************/
bool OGLES3MultipleRenderTargets::LoadPFX(CPVRTString *pErrorMsg)
{
	CPVRTString error = "";
...
******************************************************************************/
void OGLES3MultipleRenderTargets::Update()
{
...
******************************************************************************/
bool OGLES3MultipleRenderTargets::RenderSceneWithEffect(const int uiEffectId, const PVRTMat4 &mProjection, const PVRTMat4 &mView)
{
...
PVRShell* NewDemo()
{
	return new OGLES3MultipleRenderTargets();
}

/******************************************************************************
 End of file (OGLES3MultipleRenderTargets.cpp)
******************************************************************************/
